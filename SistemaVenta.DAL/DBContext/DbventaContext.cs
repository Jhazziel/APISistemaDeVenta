...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C730208F0");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F2ED352B8");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483457F2AC0");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A49867DD8B");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421A52710BE4");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132AD087790");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F769C9E5E9C");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A647042579");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D561482B5BA5A");
